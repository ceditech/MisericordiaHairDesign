    ...
    return (
        <main className="min-h-screen pt-32 pb-20 px-6 max-w-7xl mx-auto space-y-32">
            ...
            <section className="text-center relative">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-24 w-64 h-64 bg-[#a319c5]/10 rounded-full blur-[100px] -z-10" />
                <Badge className="mb-6 bg-[#a319c5]/10 text-[#a319c5] border-none px-6 py-2 uppercase tracking-widest text-xs font-black">
                ...
                <h1 className="text-5xl sm:text-7xl font-black text-slate-900 dark:text-white mb-8 italic uppercase tracking-tighter leading-[0.9]">
                    ...
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#a319c5] via-[#a319c5] to-emerald-500">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Button
                        ...
                        className="bg-[#a319c5] hover:bg-[#8b15a8] text-white rounded-2xl py-8 px-10 text-xl font-black shadow-2xl shadow-[#a319c5]/30 group"
                    >
            ...
            <section className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                    <h2 className="text-xs font-black uppercase tracking-[0.3em] text-[#a319c5] mb-4">Select Your Role</h2>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                    <button
                        ...
                        className={`p-10 rounded-[2.5rem] border-2 text-left transition-all relative overflow-hidden group ${selectedType === "client" ? "border-[#a319c5] bg-[#a319c5]/5 shadow-xl shadow-[#a319c5]/5" : "border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-[#a319c5]/30"}`}
                    >
                        {selectedType === "client" && <CheckCircle className="absolute top-8 right-8 text-[#a319c5]" size={32} />}
                        <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 transition-colors ${selectedType === "client" ? "bg-[#a319c5] text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-400"}`}>
                            <Users size={32} />
                        </div>
                        ...
                        <Badge className="bg-[#a319c5] text-white border-none font-black px-4 py-2 text-lg italic shadow-lg shadow-[#a319c5]/20">
                            10% OFF NEXT SERVICE
                        </Badge>
                    </button>
            ...
            <section id="how-it-works" className="max-w-5xl mx-auto">
                <div className="bg-slate-900 dark:bg-slate-800 rounded-[3rem] p-12 sm:p-20 text-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-1/2 h-full bg-[radial-gradient(circle_at_top_right,rgba(163,25,197,0.2),transparent_70%)]" />
                    ...
                    <div className="relative z-10 grid lg:grid-cols-2 gap-20 items-center">
                        <div>
                            <h2 className="text-xs font-black uppercase tracking-[0.3em] text-[#a319c5] mb-6">Process</h2>
                            <h3 className="text-4xl sm:text-5xl font-black italic uppercase tracking-tighter leading-none mb-10">
                                Simple Steps To <br />
                                <span className="text-[#a319c5]">Start Earning</span>
                            </h3>
                            ...
                            <div className="space-y-10">
                                {[
                                    ...
                                    <div key={idx} className="flex gap-6 group">
                                        <span className="text-2xl font-black text-white/20 group-hover:text-[#a319c5] transition-colors italic">{item.step}</span>
                                        <div>
                                            <h4 className="text-lg font-bold uppercase tracking-widest text-[#a319c5] mb-2">{item.title}</h4>
                        ...
                        <div className="hidden lg:block relative">
                            <div className="aspect-[4/5] rounded-[2.5rem] bg-gradient-to-br from-slate-800 to-slate-950 border border-slate-700/50 p-12 flex flex-col justify-center items-center text-center shadow-2xl relative">
                                <Sparkles className="text-[#a319c5] mb-8 animate-pulse" size={64} />
                                ...
                                <div className="p-4 bg-white/5 rounded-2xl border border-white/10 w-full">
                                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#a319c5] mb-2">Next Payout Window</p>
                                    <p className="text-xl font-bold">End of Month</p>
                                </div>
                                {/* Floating elements */}
                                <div className="absolute -top-6 -right-6 w-24 h-24 bg-[#a319c5]/20 rounded-full blur-2xl" />
            ...
            <section id="generate-section" className="max-w-4xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-xs font-black uppercase tracking-[0.3em] text-[#a319c5] mb-4">The Generator</h2>
                ...
                {!generatedProfile ? (
                        ...
                        <form onSubmit={handleGenerateCode} className="space-y-8">
                            <div className="grid sm:grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    ...
                                    <Input
                                        ...
                                        className="rounded-2xl py-8 px-6 text-lg border-2 focus:border-[#a319c5] transition-all"
                                        value={name}
                            ...
                            <div className="bg-slate-50 dark:bg-slate-900/50 p-8 rounded-3xl border border-dashed border-slate-200 dark:border-slate-800">
                                ...
                                <div className="flex items-center gap-4">
                                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${selectedType === 'client' ? 'bg-[#a319c5]/10 text-[#a319c5]' : 'bg-emerald-500/10 text-emerald-500'}`}>
                            ...
                            <Button
                                ...
                                className={`w-full py-10 rounded-2xl text-2xl font-black italic uppercase tracking-tighter shadow-xl transition-all ${isGenerating ? 'bg-slate-400' : 'bg-[#a319c5] hover:bg-[#8b15a8] shadow-[#a319c5]/30'}`}
                            >
                    ...
                    <Card className="p-12 sm:p-20 rounded-[4rem] border-2 border-[#a319c5]/20 bg-white dark:bg-slate-900 shadow-2xl text-center space-y-10 animate-in zoom-in-95 duration-500">
                        ...
                        <div className="relative group max-w-md mx-auto">
                            <div className="bg-slate-50 dark:bg-slate-950 p-8 rounded-[2rem] border-2 border-[#a319c5] text-4xl sm:text-5xl font-black text-[#a319c5] tracking-widest uppercase italic">
                                {generatedProfile.code}
                            </div>
                            <button
                                onClick={() => copyToClipboard(generatedProfile.code)}
                                className="absolute -top-4 -right-4 w-12 h-12 rounded-2xl bg-[#a319c5] text-white flex items-center justify-center shadow-lg hover:scale-110 transition-transform active:scale-95"
                            >
                                <Copy size={20} />
                            </button>
                        </div>
                        ...
                        <div className="pt-6">
                            <button
                                ...
                                className="text-xs font-black uppercase tracking-[0.2em] text-[#a319c5] hover:opacity-70 transition-opacity"
                            >
                                Generate New Code
                            </button>
                        </div>
            ...
            <section className="bg-slate-50 dark:bg-slate-900/50 rounded-[3rem] p-12 sm:p-20 relative overflow-hidden">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        <h2 className="text-xs font-black uppercase tracking-[0.3em] text-[#a319c5] mb-6">Program Rules</h2>
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={idx} className="flex gap-4 items-start">
                                    <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#a319c5] shrink-0" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div className="p-6 sm:p-8 rounded-[2.5rem] bg-white dark:bg-slate-900 shadow-xl border border-slate-100 dark:border-slate-800 text-center">
                            ...
                            <p className="text-5xl font-black text-[#a319c5] italic tracking-tighter">10%</p>
            ...
            <section className="max-w-4xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-xs font-black uppercase tracking-[0.3em] text-[#a319c5] mb-4">FAQ</h2>
            ...
            <section className="text-center">
                <div className="max-w-3xl mx-auto p-12 sm:p-20 rounded-[4rem] bg-slate-900 text-white relative overflow-hidden shadow-2xl">
                    <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_top_left,rgba(163,25,197,0.4),transparent_60%)]" />
                    <div className="relative z-10">
                        <HelpCircle className="mx-auto text-[#a319c5] mb-8" size={64} />
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                            <Link
                                href="/contact"
                                className="bg-[#a319c5] hover:bg-[#8b15a8] text-white px-10 py-7 rounded-2xl font-black uppercase tracking-widest text-sm inline-flex items-center justify-center transition-all shadow-lg active:scale-95"
                            >
                                Contact Support
                            </Link>
