                    ...
                    <div className="space-y-6">
                        ...
                        <div className="pt-4">
                            ...
                            <div className="flex gap-4 px-4">
                                {[
                                    { name: 'Facebook', url: 'https://www.facebook.com/108665884265377', icon: 'M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm3.893 12.89l.443-2.89h-2.773v-1.875c0-.79.387-1.563 1.63-1.563h1.26v-2.46s-1.144-.196-2.238-.196c-2.284 0-3.777 1.385-3.777 3.89V12h-2.54v2.89h2.54v6.988a10.04 10.04 0 003.124 0v-6.987h2.33z' },
                ...
                <div className="relative">
                    <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto mb-10 text-center">
                        ...
                        <p className="text-text-secondary max-w-xl mx-auto">
                            Located in the heart of Manor, TX — stop by for your next style transformation.
                        </p>
                    </div>
