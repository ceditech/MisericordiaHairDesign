                    ...
                    <div className="space-y-6">
                        ...
                        <div className="pt-4">
                            ...
                            <div className="flex gap-4 px-4">
                                {[
                                    { name: 'Facebook', url: 'https://www.facebook.com/profile.php?id=61585347691705', icon: 'M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm3.893 12.89l.443-2.89h-2.773v-1.875c0-.79.387-1.563 1.63-1.563h1.26v-2.46s-1.144-.196-2.238-.196c-2.284 0-3.777 1.385-3.777 3.89V12h-2.54v2.89h2.54v6.988a10.04 10.04 0 003.124 0v-6.987h2.33z' },
                                    ...
                                    { name: 'TikTok', url: 'https://www.tiktok.com/@misericordiahairdesign', icon: 'M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm4.972 8.87a3.5 3.5 0 0 1-2.654-1.448v4.932c0 2.014-1.632 3.646-3.646 3.646s-3.646-1.632-3.646-3.646 1.632-3.646 3.646-3.646c.055 0 .109.004.162.011v1.797a1.864 1.864 0 0 0-.162-.007c-1.028 0-1.86 0.832-1.86 1.86s.832 1.86 1.86 0.833 0 1.86-1.84 0 1.86-0.832 1.86-1.86V6h1.719c.162 1.541 1.405 2.745 2.951 2.858v1.997c-.098 0.009-.197 0.014-.296 0.015z' },
                                    ...
                                    <Tooltip key={social.name} content={`Follow on ${social.name}`} position="top">
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="w-12 h-12 rounded-2xl bg-surface border border-border flex items-center justify-center text-brand-primary hover:bg-brand-primary hover:text-white hover:border-brand-primary transition-all duration-300"
