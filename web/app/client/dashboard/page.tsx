    ...
    if (loading || fetching) {
        return (
            <main className="min-h-screen pt-32 pb-20 px-6 max-w-5xl mx-auto flex flex-col items-center justify-center">
                <RefreshCw size={40} className="text-[#a319c5] animate-spin mb-4" />
        ...
        return (
            <main className="min-h-screen pt-32 pb-20 px-6 max-w-2xl mx-auto text-center">
                ...
                <Link
                    ...
                    className="inline-flex bg-[#a319c5] hover:bg-[#8b15a8] text-white py-4 px-8 rounded-2xl items-center gap-3 font-black transition-all active:scale-[0.98]"
                >
                    Sign In
                </Link>
            </main>
        ...
        <main className="min-h-screen pt-32 pb-20 px-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-12">
                <div className="flex items-center gap-6 text-center sm:text-left">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-[#a319c5] to-indigo-500 flex items-center justify-center text-white text-3xl font-black shadow-xl shadow-indigo-500/20 shrink-0">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    <div>
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <Badge className="bg-[#a319c5]/10 text-[#a319c5]">
                ...
                <div className="space-y-6">
                    <Card className="p-6 rounded-3xl bg-gradient-to-br from-[#a319c5] to-indigo-600 text-white shadow-xl shadow-indigo-500/20 border-none overflow-hidden relative">
                    ...
                    <Card className="p-6 rounded-3xl border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
                        ...
                        <a href="#" className="text-sm font-bold text-[#a319c5] hover:underline">
                            Get Directions
                        </a>
                    </Card>
                </div>
...
function UpcomingBookingCard({ booking }: { booking: BookingRecord }) {
    return (
        <Card className="p-6 sm:p-8 rounded-[2rem] border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm hover:shadow-xl transition-all group overflow-hidden relative">
            <div className="absolute top-0 left-0 w-2 h-full bg-[#a319c5]" />
            <div className="flex flex-col sm:flex-row gap-6 relative">
                <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="flex items-center gap-3 text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-slate-800/50 p-3 rounded-xl">
                            <Calendar size={18} className="text-[#a319c5]" />
                            <span className="font-bold text-sm sm:text-base">{booking.date}</span>
                        </div>
                        <div className="flex items-center gap-3 text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-slate-800/50 p-3 rounded-xl">
                            <Clock size={18} className="text-[#a319c5]" />
                ...
                <div className="flex flex-col gap-3 justify-center border-t sm:border-t-0 sm:border-l border-slate-100 dark:border-slate-800 pt-4 sm:pt-0 sm:pl-6 shrink-0 mt-2 sm:mt-0">
                    ...
                    <button className="w-full sm:w-auto bg-transparent border-2 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 px-6 py-3 rounded-xl font-bold hover:border-[#a319c5] hover:text-[#a319c5] transition-all text-sm flex items-center justify-center gap-2">
                        Reschedule
                    </button>
                </div>
            </div>
...
function PastBookingCard({ booking }: { booking: BookingRecord }) {
    return (
        <Card className="p-5 rounded-2xl border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 flex flex-col justify-between">
            ...
            <button className="text-left text-sm font-bold text-[#a319c5] hover:underline w-max">
                Book Again
            </button>
        </Card>
    );
